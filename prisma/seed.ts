...
async function main() {
  ...
  const productTemplates = [
    ...
    },
    {
      ...
      categoryName: "RTD Tea",
      price: 54000,
    }, // Dus (isi 24)
    {
      id: "FLORIDINA",
      name: "Floridina Orange 350ml",
      categoryName: "RTD Juice",
      price: 32000,
    }, // Dus (isi 12)
    {
      id: "COCA-COLA",
      name: "Coca-Cola Kaleng 330ml",
      categoryName: "Carbonated Drink",
      price: 85000,
    }, // Dus (isi 24)
    {
      id: "SPRITE",
  ...
  const sampleOrders = [
    // Palembang Orders
    {
      ...
      items: [
        {
          productId: "AQUA-600-PAL",
          productName: "AQUA Botol 600ml (Palembang)",
          quantity: 20,
          price: 45000,
        },
        {
          productId: "TEH-PUCUK-PAL",
          productName: "Teh Pucuk Harum 350ml (Palembang)",
          quantity: 15,
          price: 54000,
        },
      ],
    ...
    },
    {
      ...
      items: [
        {
          productId: "AQUA-1500-PAL",
          productName: "AQUA Botol 1500ml (Palembang)",
          quantity: 10,
          price: 48000,
        },
        {
          productId: "COCA-COLA-PAL",
          productName: "Coca-Cola Kaleng 330ml (Palembang)",
          quantity: 5,
          price: 85000,
        },
      ],
    ...
    },
    {
      ...
      items: [
        {
          productId: "FLORIDINA-PAL",
          productName: "Floridina Orange 350ml (Palembang)",
          quantity: 2,
          price: 32000,
        },
      ],
    ...
    // Baturaja Orders
    {
      ...
      items: [
        {
          productId: "AQUA-600-BAT",
          productName: "AQUA Botol 600ml (Baturaja)",
          quantity: 30,
          price: 45000,
        },
        {
          productId: "VIT-600-BAT",
          productName: "VIT Botol 600ml (Baturaja)",
          quantity: 25,
          price: 34000,
        },
      ],
    ...
    },
    {
      ...
      items: [
        {
          productId: "TEH-PUCUK-BAT",
          productName: "Teh Pucuk Harum 350ml (Baturaja)",
          quantity: 8,
          price: 54000,
        },
      ],
    ...
    // Jambi Orders
    {
      ...
      items: [
        {
          productId: "COCA-COLA-JAM",
          productName: "Coca-Cola Kaleng 330ml (Jambi)",
          quantity: 12,
          price: 85000,
        },
      ],
